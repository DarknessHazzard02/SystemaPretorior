--NMC C15 All jobs Date completed DFF MOTORES - Sheet1
SELECT
       o243345.date_released,
       o100934.item_number,
       o100934.mfg_order_name,
       o243345.date_completed,
       o1083657.production_line,
       o211221.start_quantity as "Start Quantity",
       ...
       o100365.item_type,
       o100934.start_date,
       o100934.completed_quantity,
       o100365.description as "Description",
       o100934.organization_name,
       o100934.mfg_order_type,
       o100934.description as "Description 1",
       to_date(o211221.attribute1, 'DD-MON-YYYY HH:MI:SS') as "Revised Schedule Date",
...
FROM
    ...
    (
        ...
        WHERE
            ...
            --AND we.wip_entity_name = '24703280-1'
    ...
    ( /* Formatted on 2008/11/19 16:24 (Formatter Plus v4.8.8) */
        ...
        FROM
            apps.mtl_categories            ca,
            apps.mtl_category_sets         caset,
            apps.mtl_system_items          sy,
            apps.mtl_parameters            pa,
            apps.hr_all_organization_units al,
            apps.mtl_item_categories       it
        WHERE
...
WHERE
    ...
    /*AND ( o243345.date_released > TO_DATE('20231101000000', 'YYYYMMDDHH24MISS') )
